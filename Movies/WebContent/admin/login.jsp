					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr valign="top">
							<td bgcolor="#FFFFFF" align="center">
								<form action="admin/login.action" method="post" name="myform">
									<table width="60%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
										<tr>
											...
											<td width="76%" align="left" bgcolor="#FFFFFF">
												<input type="text" name="admin.username" size="25" class="inputBg" id="username" />
											</td>
										</tr>
										<tr>
											<td width="28%" align="right" bgcolor="#FFFFFF">
											...
											<td width="76%" align="left" bgcolor="#FFFFFF">
												<input name="admin.password" type="password" size="25" class="inputBg" />
											</td>
										</tr>
										<tr>
