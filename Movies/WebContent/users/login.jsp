								...
								<form action="index/login.action" method="post" name="myform">
									<table width="60%" border="0" cellpadding="5" cellspacing="1"
										...
										<tr>
											...
											<td width="76%" align="left" bgcolor="#FFFFFF">
												<input name="code" type="text" size="25" class="inputBg" />
												<img src="img/createImageAction.action"
													onclick="this.src='img/createImageAction.action?random='+ Math.random()" title="点击图片刷新验证码" />
											</td>
										</tr>
										<tr>
