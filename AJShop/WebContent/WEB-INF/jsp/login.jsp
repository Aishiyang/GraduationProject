...
<div class="container header">
	<div class="span5">
		<div class="logo">
			<a href="index.action"> <img style="margin-top: -52px; width: 180px; height: 150px;"
					src="${pageContext.request.contextPath}/image/r___________renleipic_01/logofresh.jpg" />
				</a>
		</div>
	</div>
	<div class="span9">
...
<div class="ad">
		...
		<div class="span12 last">
			<div class="wrap">
				<div class="main">
					<div class="title">
						<strong><s:text name="home.title"/></strong>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<form id="loginForm" action="${ pageContext.request.contextPath }/user_login.action"  method="post" novalidate="novalidate">
						<table>
							...
							<tr>
								...
								<td>
									<input type="submit" class="submit" value="<s:text name='home.login'/>">
								</td>
							</tr>
							<tr class="register">
								<th>&nbsp;
								...
								<td>
									<dl>
										<dt><s:text name="home.why"/>？</dt>
										<dd>
											<s:text name="home.nowregist"/>！
											<a href="${ pageContext.request.contextPath }/user_registPage.action">
												<s:text name="home.goregist"/>
											</a>
										</dd>
									</dl>
								</td>
...
<div class="container footer">
	...
	<div class="span24">
		<div class="copyright">Copyright © 2018-2018 FRESH水果 版权所有</div>
	</div>
</div>
</body></html>