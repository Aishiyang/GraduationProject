...
<title>忍者村</title>
<link href="${pageContext.request.contextPath}/css/guojia.css" type="text/css" rel="stylesheet" />
</head>
<body>
<div class="top"></div>
<div id="wrap"><!--整体-->
    ...
    <div style=" clear:both;"></div>
     <div>
    <div class="box-nav">
                    <div class="box-nav-left"><img src="${pageContext.request.contextPath }/img/rzc.png" width="149"/></div>
                    <div class="box-nav-right"><strong>首页 > 地理世界 > 忍者村</strong></div>
                </div>
    <img src="${pageContext.request.contextPath }/img/01.png" width="1003"/>
    <div class="abouttext"> 
        	<p><strong>忍者村</strong></p>
            <div style="border:#ccc 1px dashed; width:90%; margin:10px auto;"></div>
            <p><span>发布时间：2017-12-22   信息来源：百度百科</span></p>
            <div class="text"><p>忍者村： 是忍者聚居的村子，相等于国家的军事力量。绝大部分村民都是忍者，有一些忍者会在村内开设书店、餐厅等，不过大部分忍者都是为村子执行任务的忍者，以赚取酬劳，并于战时为国家出战。村子亦会培训年轻村民成为忍者。忍者五大国的忍村首领称为影。</p>    
    <div class="abouttext-img"><img src="${pageContext.request.contextPath }/img/rzc-2.jpg" width="50%"/></div>
    <p> 各大忍者村： 木叶村 砂隐村 雾隐村 云隐村 岩隐村 星隐村 音隐村 烟隐村 泷隐村 雨隐村 草隐村 雪隐村 匠忍村 汤忍村 锁前村 商忍村 抚子村 竹之村</p>
	</div>
        </div>
    <img src="${pageContext.request.contextPath }/img/01.png" width="1003"/>
    </div>
